...
public class SecretRenderer extends HtmlBasicInputRenderer {
    ...
    private static final String[] ATTRIBUTES = AttributeManager.getAttributes(AttributeManager.Key.INPUTSECRET);
    ...
    protected void getEndTextToRender(FacesContext context, UIComponent component, String currentValue)
        ...
        if (null != (styleClass = (String) component.getAttributes().get("styleClass"))) {
            ...
            // default css TODO hebei SecretRenderer
            writer.writeAttribute("class", "inputText", "styleClass");
        }
