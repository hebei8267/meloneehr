...
public class CommandLinkRenderer extends LinkRenderer {
	...
	private static final String SCRIPT_STATE = RIConstants.FACES_PREFIX + "scriptState";
	...
	public void encodeEnd(FacesContext context, UIComponent component) throws IOException {
		...
		String formClientId = getFormClientId(component, context);
		if (formClientId == null) {
			writer.write(MessageUtils.getExceptionMessageString(MessageUtils.COMMAND_LINK_NO_FORM_MESSAGE_ID));
	...
	protected String getOnClickScript(String formClientId, String commandClientId, String target, Param[] params) {
	...
	protected void renderAsActive(FacesContext context, UIComponent command) throws IOException {
		...
		sb.append(getOnClickScript(formClientId, commandClientId, target, params));
