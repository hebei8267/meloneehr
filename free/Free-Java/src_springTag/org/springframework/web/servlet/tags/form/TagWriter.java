...
public class TagWriter {
    ...
    /**
     * Stores {@link TagStateEntry tag state}. Stack model naturally supports
     * tag nesting.
     */
    private final Stack tagState = new Stack();

    /**
     * Create a new instance of the {@link TagWriter} class that writes to the
     * supplied {@link PageContext}.
     * 
    ...
    /**
     * Start a new tag with the supplied name. Leaves the tag open so that
     * attributes, inner text or nested tags can be written into it.
     * 
     * @see #endTag()
     */
     ...
     * <p>
     * Be sure to write all attributes <strong>before</strong> writing any
     * inner text or nested tags.
     * 
    ...
    /**
     * Close the current opening tag (if necessary) and appends the supplied
     * value as inner text.
     * 
    ...
    /**
     * Indicate that the currently open tag should be closed and marked as a
     * block level element.
     * <p>
     * Useful when you plan to write additional content in the body outside the
     * context of the current {@link TagWriter}.
     */
     ...
     * <p>
     * Correctly writes an empty tag if no inner text or nested tags have been
     * written.
     */
     ...
     * written.
     * 
     * @param enforceClosingTag whether a full closing tag should be rendered in
     *            any case, even in case of a non-block tag
     */
