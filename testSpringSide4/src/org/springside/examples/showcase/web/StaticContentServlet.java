 ...
 * 
 * 演示访问地址为： static-content?contentPath=static/img/logo.jpg
...
public class StaticContentServlet extends HttpServlet {
	...
	/** 需要被Gzip压缩的Mime类型. */
	private static final String[] GZIP_MIME_TYPES = { "text/html", "text/xml", "text/plain", "text/css", "text/javascript",
