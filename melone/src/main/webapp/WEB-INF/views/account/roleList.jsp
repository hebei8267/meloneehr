...
<html>
		...
		<script>
			$().ready(function() {
				...
				$("#newBtn").click(function() {
					$(location).attr('href', '${sc_ctx}/account/role/new');
				});
						...
						$("#__del-confirm").dialog({
							...
							buttons: {
								"删除": function() {
									...
									$("#uuids").val(uuids);
									$("#listForm").attr("action", "${sc_ctx}/account/role/del");
						        	$("#listForm").submit();
								},
								"关闭": function() {
									$( this ).dialog( "close" );
				...
				$("#serchBtn").click(function() {
					...
					$("#serchForm").attr("action", "${sc_ctx}/account/role/list");
					$("#serchForm").submit();
				});
			});
		</script>
	...
	<body>
		...
		<div class="grid_16 titleNav">
			<h2><a>配置管理</a>&#8711; <a>安全相关</a>&#8711; <a>角色</a></h2>
		</div>
		<div class="clear"></div>
		...
		<div class="grid_8 suffix_8">
			<table class="search_table">
				<tr>
					<td class="item_name" width="90px">角色名称:</td>
					<td class="item" width="180px">
						<input type="text" name="name" value="${role.name}" class="text ui-widget-content ui-corner-all"/>
					</td>
		...
		<div class="grid_16">
			...
			<table id="rounded-corner">
				...
				<tbody>
					...
					<tr>
						<td class="first">
							<input type="checkbox" name="uuid" value="${role.uuid}"></input>
						</td>
						<td>
							${role.name}&nbsp;
						</td>
