		...
		.create( {
			...
			start : function(options) {
				...
				eval('this.render = function(pos){ '
						...
						+ this.fromToDelta + '+' + this.options.from + ';'
						+ 'this.position=pos;'
				...
				Effect.Base,
				{
					...
					setup : function() {
						...
						this._base = $R(0, 2).map(function(i) {
							return parseInt(this.options.startcolor.slice(i * 2
									+ 1, i * 2 + 3), 16)
						}.bind(this));
						this._delta = $R(0, 2).map(function(i) {
							return parseInt(this.options.endcolor.slice(i * 2
									+ 1, i * 2 + 3), 16)
									- this._base[i]
						}.bind(this));
					},
					...
					setup : function() {
						function parseColor(color) {
							...
							return $R(0, 2).map(function(i) {
								return parseInt(color.slice(i * 2 + 1, i * 2
										+ 3), 16)
							});
						}
