...
public interface IDD_Communal_Service {
     ...
     * 该树的根节点对象(包含子树节点)
     */
    public abstract void getNativeplaceInfoTree_Service();
     ...
     * 所有节点对象数据列表
     */
    public abstract void getNativeplaceInfoList_Service();
     ...
     */
    public abstract void delNativeplaceInfo_Service(String nativeplaceID, String pNativeplaceID);
     ...
     * @param pNativeplaceID 父籍贯信息ID
     */
    public abstract void addNativeplaceInfo_Service(String nativeplaceID, String pNativeplaceID);

    /**
     * 更新籍贯信息
     * 
     * 0-更新成功 1-更新失败(数据不存在) 2-更新失败(存在类似的籍贯)成功
     */
    public abstract void updateNativeplaceInfo_Service(籍贯 obj);
}
