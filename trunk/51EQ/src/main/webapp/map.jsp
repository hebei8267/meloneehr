...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
	    ...
	    //标注点数组
	    var markerArr = [{title:"总部",content:"硚口区古田四路13号江城壹号A区17号楼107室（招商部正门隔壁）<br/>Tel: 027-83800488",point:"114.220679|30.603698",isOpen:0,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
