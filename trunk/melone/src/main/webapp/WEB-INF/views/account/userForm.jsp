			...
			<table>
				<tr>
					...
					<td align="center" rowspan="7" style="padding-left: 40px;vertical-align: top;">
						<table>
							<tr>
								<td><img id="img" height="<%=Constants.PHOTO_IMG_HEIGHT %>px" width="<%=Constants.PHOTO_IMG_WIDTH %>px" style="border: 1px;" src="${ctx}/photoServlet?photoName=${user.photoName}&type=userPhoto"/></td>
							</tr>
							<tr><%// 图像文件上传 %>
