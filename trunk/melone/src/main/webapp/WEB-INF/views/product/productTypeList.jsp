...
<html>
		...
		<script>
			$().ready(function() {
				...
				$("#newBtn").click(function() {
					$(location).attr('href', '${sc_ctx}/product/productType/new');
				});
				...
				$("#delBtn").click(function() {
					...
					$("#uuids").val(uuids);
					$("#listForm").attr("action", "${sc_ctx}/product/productType/del");
		        	$("#listForm").submit();
				});
			});
		</script>
	...
	<body>
		...
		<div class="grid_16 titleNav">
			<h2><a>配置管理</a>&#8711; <a>产品相关</a>&#8711; <a>产品类型</a></h2>
		</div>
		<div class="clear"></div>
		...
		<div class="grid_16">
			...
			<table id="rounded-corner">
				...
				<tbody>
					...
					<tr>
						<td class="first">
							<input type="checkbox" name="uuid" value="${productType.uuid}"></input>
						</td>
						<td>
							${productType.name}&nbsp;
						</td>
						...
						<td align="center">
							<a href="${sc_ctx}/product/productType/edit/${productType.uuid}">编辑</a>
						</td>
					</tr>
					</c:forEach>
				</tbody>
