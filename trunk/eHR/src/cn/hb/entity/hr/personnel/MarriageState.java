 ...
 */
@Entity
@Table(name = "M_MARRIAGE_STATE")
public class MarriageState extends AbstractEntityBean {

    private static final long serialVersionUID = 2972556039037600053L;
     ...
     */
    @NaturalId
    @Column(name = "MARRIAGE_STATE_MASTER_ID", nullable = false, length = 20)
    public String getMasterID() {
        return masterID;
    }

    @NaturalId
    @Column(name = "MARRIAGE_STATE_SLAVE_ID", nullable = false, length = 20)
    ...
    public boolean equals(Object object) {
        if (!(object instanceof MarriageState)) {
            return false;
        }
        MarriageState rhs = (MarriageState) object;
