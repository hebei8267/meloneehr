...
/**
 * <B>SelectManyCheckboxListRenderer</B> is a class that renders the current
 * value of <code>UISelectMany<code> component as a list of checkboxes.
 */
...
public class SelectManyCheckboxListRenderer extends MenuRenderer {
		...
		if (!items.isEmpty()) {
			...
			for (SelectItem curItem : items) {
				...
				if (curItem instanceof SelectItemGroup) {
					...
					renderOption(context, component, converter, curItem, currentSelections, submittedValues, alignVertical, idx);
				}
			}
		}
	...
	protected void renderBeginText(UIComponent component, int border, boolean alignVertical, FacesContext context,
	...
	protected void renderOption(FacesContext context, UIComponent component, Converter converter, SelectItem curItem,
			Object currentSelections, Object[] submittedValues, boolean alignVertical, int itemNumber) throws IOException {
	...
	@Deprecated
	protected void renderOption(FacesContext context, UIComponent component, Converter converter, SelectItem curItem,
			boolean alignVertical, int itemNumber) throws IOException {

		renderOption(context, component, converter, curItem, getCurrentSelectedValues(component),
				getSubmittedSelectedValues(component), alignVertical, itemNumber);
