...
public class LabelRenderer extends HtmlBasicInputRenderer {
	...
	private static final String[] ATTRIBUTES = AttributeManager.getAttributes(AttributeManager.Key.OUTPUTLABEL);
	...
	/**
	 * Builds and returns the clientId of the component that is represented by
	 * the forValue. Since the component has not been created yet, invoking
	 ...
	 * @param forValue String representing the "id" of the component that this
	 *            label represents.
	 * 
