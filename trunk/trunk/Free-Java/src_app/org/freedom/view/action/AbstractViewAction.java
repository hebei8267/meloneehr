...
public abstract class AbstractViewAction extends BaseBean {
    ...
    protected String getMessage(HttpServletRequest request, String msgKey, Object[] args, Locale locale) {
        ResourceBundleMessageSource msgObj = (ResourceBundleMessageSource) WebApplicationContextUtil.getApplicationBean(request,
                "messageSource");
    ...
    protected List<Object> jsonStr2PojoList(String jsonString, Class pojoClass) {
