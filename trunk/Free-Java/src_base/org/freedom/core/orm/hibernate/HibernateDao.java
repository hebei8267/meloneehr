...
import org.freedom.core.orm.modules.Page;
import org.freedom.core.orm.modules.PropertyFilter;
import org.freedom.core.orm.modules.PropertyFilter.MatchType;
...
/**
 * 封装扩展功能的BaseHibernateDao范型基类<br>
 * 扩展功能包括分页查询,按属性过滤条件列表查询等.<br>
...
public class HibernateDao<T> extends BaseHibernateDao<T> {
    /**
     * 用于扩展的DAO子类使用的构造函数.
     * 
     ...
     * 
     * HibernateDao<User> userDao = new HibernateDao<User>(sessionFactory, User.class);
     */
     ...
     * 按Criteria分页查询.
     * 
     * @param page 分页参数.支持pageSize、firstResult和orderBy、order、autoCount参数. 其中autoCount指定是否动态获取总结果数.
