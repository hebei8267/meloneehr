...
/**
 * Arbitrary grouping "renderer" that simply renders its children recursively in
 * the <code>encodeEnd()</code> method.
 * 
...
public class GroupRenderer extends HtmlBasicRenderer {
	...
	private boolean divOrSpan(UIComponent component) {
		...
		return (shouldWriteIdAttribute(component) || (component.getAttributes().get("style") != null) || (component
