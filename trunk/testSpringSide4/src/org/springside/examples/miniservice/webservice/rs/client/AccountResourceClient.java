...
public class AccountResourceClient {
	...
	public UserDTO getUser(Long id) {
		System.out.println(client.path("/users/" + id).accept(MediaType.APPLICATION_JSON));
	...
	public URI createUser(UserDTO user) {
		ClientResponse response = client.path("/users").entity(user, MediaType.APPLICATION_JSON).post(ClientResponse.class);
	...
	public static void main(String[] args) {
		...
		client.setBaseUrl("http://127.0.0.1:8080/mytest/rs");
