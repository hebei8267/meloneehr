 ...
 * property is '<code>command</code>' which corresponds to the default name when
 * using the {@link org.springframework.web.servlet.mvc.SimpleFormController
...
public class FormTag extends AbstractHtmlElementTag {
    ...
    /**
     * The name of the {@link javax.servlet.jsp.PageContext} attribute under
     * which the form object name is exposed.
     */
     ...
     * May be a runtime expression.
     * <p>
     * Name is not a valid attribute for form on XHTML 1.0. However, it is
     ...
     * 
     * @param tagWriter the {@link TagWriter} to which the form content is to be
     *            written
    ...
    protected int writeTagContent(TagWriter tagWriter) throws JspException {
        ...
        this.pageContext.setAttribute(NESTED_PATH_VARIABLE_NAME, modelAttribute + PropertyAccessor.NESTED_PROPERTY_SEPARATOR,
     ...
     * 
     * @throws IllegalArgumentException if the form object resolves to
     *             <code>null</code>
     */
     ...
     * <p>
     * If the user configured an '<code>action</code>' value then the result of
     * evaluating this value is used. Otherwise, the
     * {@link org.springframework.web.servlet.support.RequestContext#getRequestUri()
     * originating URI} is used.
     * 
     * @return the value that is to be used for the '<code>action</code>'
     *         attribute
     */
    ...
    private void writerJavascript() throws JspException {
        List<String> scriptList = (List<String>) this.pageContext.getAttribute(AbstractJQueryTag.JQUERY_COMPONENT_SCRIPT_NAME);
        if (scriptList != null) {
        ...
        this.pageContext.removeAttribute(AbstractJQueryTag.JQUERY_COMPONENT_SCRIPT_NAME, PageContext.PAGE_SCOPE);
    }
}
